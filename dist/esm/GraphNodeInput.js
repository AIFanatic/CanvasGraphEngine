...
var GraphNodeInput = /** @class */ (function () {
    ...
    GraphNodeInput.prototype.draw = function (ctx, x, y) {
        ctx.save();
        this.properties.position = { x: x, y: y };
        this.slotCenter = { x: this.properties.position.x + this.properties.margin, y: this.properties.position.y + this.properties.size.h / 2 };
